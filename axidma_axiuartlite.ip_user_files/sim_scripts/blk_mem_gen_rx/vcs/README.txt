...
#
# Generated by export_simulation on Fri Apr 08 22:01:44 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_rx.sh' script.

./blk_mem_gen_rx.sh -reset_run
...
./blk_mem_gen_rx.sh -noclean_files

For more information on the script, please type './blk_mem_gen_rx.sh -help'.
